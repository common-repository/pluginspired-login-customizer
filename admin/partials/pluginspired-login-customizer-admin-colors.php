	...
	<div class="main-left">
		...
		<form id="pluginspired_settings" method="post" action="options.php">
			...
			<div class="tab-container">
				...
				<ul class="tabs">
					<li class="tab-link current"><a href="<?php echo admin_url( 'admin.php?page=pluginspired-login-customizer' ); ?>"><?php _e('Colors &amp; Styles') ?></a></li>
					<li class="tab-link"><a href="<?php echo admin_url( 'admin.php?page=pluginspired-login-customizer-logo' ); ?>"><?php _e('Logo') ?></a></li>
					<li class="tab-link"><a href="<?php echo admin_url( 'admin.php?page=pluginspired-login-customizer-background' ); ?>"><?php _e('Background') ?></a></li>
				</ul>

				<div class="tab-content current">

					<?php
            settings_fields( 'pluginspired_login_customizer_colors_settings_group' );
            do_settings_sections( 'pluginspired_login_customizer_colors_settings_group' );
            submit_button();
          ?>
